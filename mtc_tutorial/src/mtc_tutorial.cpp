...
void MTCTaskNode::setupPlanningScene()
{
  ...
  auto const collision_object = [frame_id =  "world"] {
    ...
    collision_object.primitives[0].dimensions = { 0.2, 0.2,0.01 };
    

    geometry_msgs::msg::Pose floor_pose;
    floor_pose.position.x = -0.35;
    floor_pose.position.y = -0.03;
    floor_pose.position.z = -0.005;
    floor_pose.orientation.w = 1.0;
    collision_object.pose = floor_pose;
